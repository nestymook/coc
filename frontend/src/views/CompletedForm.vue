  ...
  <div class="completed-form-container">
    <div class="page-header">
      ...
      <el-breadcrumb separator="/">
        ...
        <el-breadcrumb-item :to="{ path: '/my-forms', query: { status: 'COMPLETED' } }">My Forms</el-breadcrumb-item>
        <el-breadcrumb-item>Completed Forms</el-breadcrumb-item>
      </el-breadcrumb>
    </div>
    ...
    <el-card class="form-card">
      ...
      <div class="form-content">
        <el-descriptions :column="2" border>
          ...
          <el-descriptions-item label="Completion Date">{{ form.lastActionDate ? new Date(form.lastActionDate).toLocaleString() : 'N/A' }}</el-descriptions-item>
        </el-descriptions>
